...
function MidNav({ estimateClick, setEstimateClick }) {
  const [openNav, setOpenNav] = React.useState(false);
  const [show, setShow] = useState(false);

  const handleButtonClick = () => {
    setShow(true); // Hide the motion.div when the button is clicked
  };

  const handleAnimationComplete = () => {
    setEstimateClick(true); // Set estimateClick to true after animation completes
  };
      ...
      <AnimatePresence>
        {show ? (
          ...
          <motion.div
            ...
            className="flex h-screen bg-white rounded-lg justify-center items-center"
          >
            <div className=" border-none w-3/4 px-4 py-2 lg:px-8 lg:py-4 bg-white rounded-lg shadow-xl shadow-purple-100">
          ...
          <div className="flex h-screen bg-white rounded-lg justify-center items-center">
            <div className=" border-none w-3/4 px-4 py-2 lg:px-8 lg:py-4 bg-white rounded-lg shadow-xl shadow-purple-100">
              <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
                <Typography
                  as="a"
