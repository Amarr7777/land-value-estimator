...
export function NavbarDefault() {
    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <input
          type="text"
          placeholder="Village"
          class="px-2 py-1 placeholder-blueGray-300 text-blueGray-600 relative bg-white text-black  rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full"
        />
      </Typography>
      <Typography
        as="li"
  ...
  return (
    <Navbar className="mx-auto border-none w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1">
          <Button
            variant="text"
            size="sm"
            className="hidden lg:inline-block border border-black rounded-md "
          >
